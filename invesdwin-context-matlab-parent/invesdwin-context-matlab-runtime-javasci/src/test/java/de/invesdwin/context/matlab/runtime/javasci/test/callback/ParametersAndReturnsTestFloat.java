...
public class ParametersAndReturnsTestFloat {
    ...
    public ParametersAndReturnsTestFloat(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestFloat.class.getSimpleName() + ".sce",
