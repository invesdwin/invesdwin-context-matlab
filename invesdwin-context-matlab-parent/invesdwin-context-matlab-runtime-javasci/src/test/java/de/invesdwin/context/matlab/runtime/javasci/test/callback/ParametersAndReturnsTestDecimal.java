...
public class ParametersAndReturnsTestDecimal {
    ...
    public ParametersAndReturnsTestDecimal(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDecimal.class.getSimpleName() + ".sce",
