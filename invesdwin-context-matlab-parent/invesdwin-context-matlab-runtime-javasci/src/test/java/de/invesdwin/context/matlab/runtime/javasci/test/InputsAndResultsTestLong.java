...
public class InputsAndResultsTestLong {
    ...
    public InputsAndResultsTestLong(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        ...
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestLong.class.getSimpleName() + ".sce",
