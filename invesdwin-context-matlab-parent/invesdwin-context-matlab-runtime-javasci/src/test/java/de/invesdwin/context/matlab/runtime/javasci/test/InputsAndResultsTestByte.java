...
public class InputsAndResultsTestByte {
    ...
    public InputsAndResultsTestByte(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        ...
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestByte.class.getSimpleName() + ".sce",
