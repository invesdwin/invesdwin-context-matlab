...
public class ParametersAndReturnsTestString {
    ...
    public ParametersAndReturnsTestString(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestString.class.getSimpleName() + ".sce",
