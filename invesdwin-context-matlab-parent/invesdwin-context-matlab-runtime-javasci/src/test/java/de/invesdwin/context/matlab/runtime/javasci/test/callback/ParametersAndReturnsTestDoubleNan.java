...
public class ParametersAndReturnsTestDoubleNan {
    ...
    public ParametersAndReturnsTestDoubleNan(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDoubleNan.class.getSimpleName() + ".sce",
