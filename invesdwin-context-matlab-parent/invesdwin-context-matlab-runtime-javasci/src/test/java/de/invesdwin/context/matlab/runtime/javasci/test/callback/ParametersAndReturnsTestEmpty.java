...
public class ParametersAndReturnsTestEmpty {
    ...
    public ParametersAndReturnsTestEmpty(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestEmpty.class.getSimpleName() + ".sce",
