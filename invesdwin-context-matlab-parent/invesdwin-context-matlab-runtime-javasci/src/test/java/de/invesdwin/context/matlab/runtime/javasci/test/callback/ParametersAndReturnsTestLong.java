...
public class ParametersAndReturnsTestLong {
    ...
    public ParametersAndReturnsTestLong(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestLong.class.getSimpleName() + ".sce",
