...
public class InputsAndResultsTestShort {
    ...
    public InputsAndResultsTestShort(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        ...
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestShort.class.getSimpleName() + ".sce",
