...
public class ParametersAndReturnsTestBoolean {
    ...
    public ParametersAndReturnsTestBoolean(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestBoolean.class.getSimpleName() + ".sce",
