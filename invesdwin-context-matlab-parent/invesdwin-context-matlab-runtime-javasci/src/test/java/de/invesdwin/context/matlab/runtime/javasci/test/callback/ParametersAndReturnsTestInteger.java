...
public class ParametersAndReturnsTestInteger {
    ...
    public ParametersAndReturnsTestInteger(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestInteger.class.getSimpleName() + ".sce",
