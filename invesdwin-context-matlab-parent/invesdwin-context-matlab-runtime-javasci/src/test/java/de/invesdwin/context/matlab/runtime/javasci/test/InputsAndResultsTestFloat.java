...
public class InputsAndResultsTestFloat {
    ...
    public InputsAndResultsTestFloat(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        ...
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestFloat.class.getSimpleName() + ".sce",
