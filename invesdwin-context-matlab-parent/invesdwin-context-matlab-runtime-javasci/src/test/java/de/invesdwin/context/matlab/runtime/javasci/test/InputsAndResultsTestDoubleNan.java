...
public class InputsAndResultsTestDoubleNan {
    ...
    public InputsAndResultsTestDoubleNan(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        ...
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDoubleNan.class.getSimpleName() + ".sce",
