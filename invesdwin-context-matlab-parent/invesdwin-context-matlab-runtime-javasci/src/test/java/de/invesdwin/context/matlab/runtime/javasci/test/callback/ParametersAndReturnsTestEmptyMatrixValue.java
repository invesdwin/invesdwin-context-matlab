package de.invesdwin.context.matlab.runtime.javasci.test.callback;
...
public class ParametersAndReturnsTestEmptyMatrixValue {
    ...
    public ParametersAndReturnsTestEmptyMatrixValue(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(
                        new ClassPathResource(ParametersAndReturnsTestEmptyMatrixValue.class.getSimpleName() + ".sce",
