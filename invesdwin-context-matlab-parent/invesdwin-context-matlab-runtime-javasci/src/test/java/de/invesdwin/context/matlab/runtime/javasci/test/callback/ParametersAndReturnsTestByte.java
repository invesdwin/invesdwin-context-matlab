...
public class ParametersAndReturnsTestByte {
    ...
    public ParametersAndReturnsTestByte(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestByte.class.getSimpleName() + ".sce",
