...
public class ParametersAndReturnsTestNullPutGet {
    ...
    public ParametersAndReturnsTestNullPutGet(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestNullPutGet.class.getSimpleName() + ".sce",
