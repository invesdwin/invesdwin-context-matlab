...
public class ParametersAndReturnsTestShort {
    ...
    public ParametersAndReturnsTestShort(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestShort.class.getSimpleName() + ".sce",
