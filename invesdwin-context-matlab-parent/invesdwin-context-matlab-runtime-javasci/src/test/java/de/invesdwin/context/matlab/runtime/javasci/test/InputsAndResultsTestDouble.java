...
public class InputsAndResultsTestDouble {
    ...
    public InputsAndResultsTestDouble(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        ...
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDouble.class.getSimpleName() + ".sce",
