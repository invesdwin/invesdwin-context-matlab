...
public class ParametersAndReturnsTestCharacter {
    ...
    public ParametersAndReturnsTestCharacter(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestCharacter.class.getSimpleName() + ".sce",
