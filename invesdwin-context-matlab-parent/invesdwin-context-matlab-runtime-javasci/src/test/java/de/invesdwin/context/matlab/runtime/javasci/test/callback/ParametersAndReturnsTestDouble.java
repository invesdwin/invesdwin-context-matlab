...
public class ParametersAndReturnsTestDouble {
    ...
    public ParametersAndReturnsTestDouble(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDouble.class.getSimpleName() + ".sce",
