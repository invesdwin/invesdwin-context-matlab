...
public class ParametersAndReturnsTestPercent {
    ...
    public ParametersAndReturnsTestPercent(final IScriptTaskRunnerMatlab runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        new AScriptTaskMatlab<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestPercent.class.getSimpleName() + ".sce",
